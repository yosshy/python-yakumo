...
class Resource(base.Resource):
    ...
    def update(self, http_method=None, url_path=None, expected_codes=None,
               delay=None, timeout=None, max_retries=None, is_enabled=None):
        """
        ...
        @type url_path: str
        @keyword expected_codes: Expected HTTP response code list
...
class Manager(base.Manager):
    ...
    def create(self, type=None, http_method=None, url_path=None,
        ...
        @keyword timeout: Maximum seconds to wait a response
        @type timeout: int
        @keyword max_retries: Number of allowed connection failures
        (up to 10)
        @type max_retries: int
        @keyword is_enabled: Whether the Monitor is enabled
        @type is_enabled: bool
        @return: Created monitor
        @rtype: yakumo.neutron.v2.lbaas.health_monitor.Resource
        """
